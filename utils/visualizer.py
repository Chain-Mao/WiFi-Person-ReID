...
class Visualizer:
    ...
    def plot_roc_curve(fpr, tpr, name='model', fig=None):
        if fig is None:
            fig = plt.figure()
            plt.plot([0, 1], [0, 1], 'r', linestyle='--', label='Random guess')
        plt.plot(fpr, tpr, color=(random.uniform(0, 1), random.uniform(0, 1), random.uniform(0, 1)),
        ...
        # 保存图像
        plt.savefig('/data1/fast-reid-wifi/tools/roc_curve.png', dpi=600, bbox_inches='tight')
